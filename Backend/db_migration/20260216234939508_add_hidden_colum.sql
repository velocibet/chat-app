/***********************************************/
/*** SCRIPT AUTHOR:                          ***/
/***    CREATED ON: 2026-02-16T23:49:39.508Z ***/
/***********************************************/
...
ALTER TABLE IF EXISTS "public"."room_user" ADD COLUMN IF NOT EXISTS "hidden" bool NULL DEFAULT false ;

COMMENT ON COLUMN "public"."room_user"."hidden"  IS NULL;
...
ALTER TABLE IF EXISTS "public"."room_user" ADD CONSTRAINT "unique_room_user" UNIQUE (room_id, user_id);

COMMENT ON CONSTRAINT "unique_room_user" ON "public"."room_user" IS NULL;
...
--- BEGIN DROP TABLE "public"."pgmigrations" ---

DROP TABLE IF EXISTS "public"."pgmigrations";  --WARN: Drop table can occure in data loss!

--- END DROP TABLE "public"."pgmigrations" ---
